...
// add_attri 可以 把属性添加到 should be added 里，或者把function 绑定到shouldadded 的onclick 事件上
/**
 ...
 */
// type 和attrlist 用于调用append childnodes 生成一个以attr为属性的type的node ，再把child add 到这个node上
